...
| GitHub and documentation | 1 | README updated with languages and how to run the UI; localization QA checklist; diagrams under `docs/diagrams/` (see README). | [README.md](../../README_old.md); [LOCALIZATION_QA_CHECKLIST.md](../LOCALIZATION_QA_CHECKLIST.md); [docs/diagrams/](../diagrams/). |
